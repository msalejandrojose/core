...
// `isActive` sigue siendo un PATCH más, no un endpoint aparte (mismo
// criterio que `UpdateTrackDto`).
export class UpdateCircuitDto {
  ...
  @ApiPropertyOptional({
    description: 'Interruptor manual: desactivar el circuito entero sin perder su histórico.',
  })
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;
